...
class SendMailsApp:
    ...
    def create_styles(self):
        ...
        self.style.configure('frame.TFrame', background="#edf2f4", foreground="#212529")
        self.style.configure('label.TLabel', background="#edf2f4", foreground="#212529")
        self.style.configure('entry.TEntry', padding=10, font=("Quicksand Medium", 12))
        self.style.configure('send.TButton', background="#5cb85c", foreground="#FFFFFF", padding=10, font=("Quicksand Bold", 10))
        self.style.map("send.TButton", background=[('active', '#4cae4c')])
        self.style.configure('clear.TButton', background="#f0ad4e", foreground="#FFFFFF", padding=10, font=("Quicksand Bold", 10))
        self.style.map("clear.TButton", background=[('active', '#ec971f')])
        self.style.configure('file.TButton', background="#0275d8", foreground="#FFFFFF", padding=10, font=("Quicksand Bold", 10))
        self.style.map("file.TButton", background=[('active', '#025aa5')])
        self.style.configure('exit.TButton', background="#d9534f", foreground="#FFFFFF", padding=10, font=("Quicksand Bold", 10))
    ...
    def create_widgets(self):
        ...
        body_frame = Frame(self.main_window, style="frame.TFrame")
        body_frame.pack(padx=20, pady=10, fill='both', expand=True)

        title_label = Label(body_frame, text="SendMails", font=("Quicksand Bold", 24), style="label.TLabel")
        title_label.grid(row=0, column=0, columnspan=2, pady=(0, 20), sticky='n')

        subject_label = Label(body_frame, text="Assunto", style="label.TLabel")
        subject_label.grid(row=1, column=0, sticky='w', padx=10, pady=(10, 0))
        self.subject_entry = Entry(body_frame, style="entry.TEntry")
        self.subject_entry.grid(row=2, column=0, columnspan=2, sticky='ew', padx=10, pady=10)
        self.subject_entry.focus()

        message_label = Label(body_frame, text="Mensagem", style="label.TLabel")
        ...
        file_image_frame = Frame(body_frame, style="frame.TFrame")
        file_image_frame.grid(row=5, column=0, columnspan=2, sticky='ew', padx=10, pady=10)
        self.file_image_entry = Entry(file_image_frame, style="entry.TEntry")
        ...
        excel_file_frame = Frame(body_frame, style="frame.TFrame")
        excel_file_frame.grid(row=6, column=0, columnspan=2, sticky='ew', padx=10, pady=10)
        self.file_excel_entry = Entry(excel_file_frame, style="entry.TEntry")
        ...
        spacer = Label(body_frame, text="", style="label.TLabel")
        spacer.grid(row=7, column=0, columnspan=2, pady=5)

        buttons_frame = Frame(body_frame, style="frame.TFrame")
        ...
        # Barra de progresso
        progress_label = Label(body_frame, text="Progresso de envio dos e-mails", style="label.TLabel")
        progress_label.grid(row=9, column=0, sticky='w', padx=10, pady=(15, 5))
        progress_frame = Frame(body_frame, style="frame.TFrame")
        ...
        # Author
        author_label = Label(body_frame, text="Desenvolvido por BRUNA GONÇALVES", font=("Quicksand Bold", 10), style="label.TLabel")
